...
Finally, I'd like to thank everyone who adopted Rust in the last years and found value in it. You helped us shape our grasp the language tremendously.

Also, I'd like to personally thank Alex, Sean and Carl for their work on `futures`, `hyper` and `tokio`, I learned a lot from you.

Additionally, I'd like to thank [@withoutboats](https://internals.rust-lang.org/t/pre-rfc-catching-functions/6505/102) for suggesting many changes to the language and following the discussions through to the end.
